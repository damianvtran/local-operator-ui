...
if __name__ == "__main__":
    ...
    for name in sys.argv[2:]:
        ...
        for k in ("probe", "probeAnyId", "standInsAll", "firstShot", "revealed", "switchLoopSettled", "holdSettled", "refindMid", "refindAfter", "live", "backOnA", "onB", "onBLater", "returnMid", "mergeRender"):
