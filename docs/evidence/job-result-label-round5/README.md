...
- **After:** the same production story with the explicit-label restoration in
  the commit that adds this directory. The working tree was modified during
  capture; this is not a clean historical-capture claim.
