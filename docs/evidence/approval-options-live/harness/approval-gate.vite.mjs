...
/**
 * Browser dev server for the REAL chat surface, used by the approval-gate
 * click proof (`docs/evidence/approval-options-live/README.md`).
 *
...
const SHIM_PATH = "/approval-gate-electron-shim.js";
...
export default defineConfig({
	...
	server: {
		port: Number(process.env.APPROVAL_GATE_PORT ?? 5302),
		strictPort: true,
		/*
...
function electronBridgeShim() {
	return {
		name: "approval-gate-electron-shim",
		apply: "serve",
