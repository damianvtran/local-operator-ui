...
UI_PORT=8080
DESK_STAMP="d482r6-$(uuidgen | tr A-Z a-z)"
...
env -u LOCAL_OPERATOR_CONFIG_DIR QA_PROXY_STATS="$STATS" QA_SEED_TURNS="${QA_SEED_TURNS:-0}" QA_RUNS="${QA_RUNS:-0}" QA_ASIDE_FIRST="${QA_ASIDE_FIRST:-0}" QA_CAP_CASES="${QA_CAP_CASES:-}" node scripts/renderer-driver-d6.mjs \
  --scene "$SCENE" \
