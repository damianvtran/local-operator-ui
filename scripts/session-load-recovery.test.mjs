...
const bundle = await build({
	stdin: {
		contents: [
			'export { useCanonicalSessionStream, STREAM_SNAPSHOT_DEADLINE_MS } from "./src/renderer/src/shared/hooks/use-canonical-session.ts";',
 ...
 */
async function runTimers({ deadline = false } = {}) {
	const delays = [];
	/*
