#!/usr/bin/env node
/**
 * QA round 1 rig for local-operator-ui PR #490 (independent of the coder's rig).
 *
...
try {
	 ...
	 */
	if (NAME === "n1-refind" || NAME === "n1-refind-noframe") {
		const other = Object.keys(scen.sessions).find((k) => k !== scen.open);
