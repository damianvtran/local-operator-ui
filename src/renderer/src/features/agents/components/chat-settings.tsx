...
const SectionTitle = styled(Typography)(({ theme }) => ({
	fontWeight: 600,
	// Adjusted marginBottom for better spacing with collapsible content
	marginBottom: theme.spacing(1),
	display: "flex",
	alignItems: "center",
	color: theme.palette.text.primary,
	padding: theme.spacing(1, 0), // Add some vertical padding for better clickability
}));

// Using a Box for the Lucide icon to allow for easier styling if needed
const TitleIconContainer = styled(Box)(({ theme }) => ({
	marginRight: theme.spacing(1.5), // Standard spacing
	display: "flex",
	alignItems: "center",
	justifyContent: "center",
	color: theme.palette.primary.main,
	// Removed padding, border-radius, and background for a cleaner Lucide icon look
}));

const InfoButton = styled(IconButton)(({ theme }) => ({
	marginLeft: theme.spacing(1),
	color: theme.palette.text.secondary, // Adjusted for a more subtle look
	"&:hover": {
		backgroundColor: alpha(theme.palette.action.hover, 0.08), // Consistent hover
	},
}));
	...
	return (
		<Box sx={{ mt: 2, mb: 1 }}>
			...
			>
				...
				<Tooltip
					title="Advanced settings to change how the agent generates responses"
					arrow
					placement="top"
				>
			...
			<Collapse in={isExpanded} timeout="auto" unmountOnExit>
				...
				>
					...
					{/* All settings are now children of this single padded Box */}
