...
import { MarkdownModal } from "./markdown-canvas/markdown-modal";
 ...
 * Includes the markdown canvas for viewing markdown documents
 */
export const ChatContentWithMarkdownCanvas: FC<ChatContentProps> = ({
	activeTab,
	onTabChange,
	agentName,
	description,
	...
	return (
		<ChatContainer elevation={0}>
			...
			{!isDevelopmentMode() || activeTab === "chat" ? (
				/* Messages container */
				<MessagesViewWithMarkdownCanvas
					messages={messages}
					isLoading={isLoading}
