 ...
 * second code path), and `Edit` puts the payload back in the box — the same act
 * the composer's own `Restore message` performs, reached from the message the
 * restore is about.
 */
				...
				>
					...
					{!missing && (
						...
						<CanvasPaneProvider conversationId={conversationId}>
							 ...
							 * the two call sites rather than kept as main's single one.
							 */}
							{rowGroups.map((group) =>
								group.kind === "run" ? (
									<TraceFold
