...
export const everforest: ThemeDefinition = {
	...
	palette: {
		...
		/*
		 * The current row's own ground: `surface` stepped 3.32 `L*` up at the panel's own
		 * hue (1.4 degrees off, inside the 12-degree bound) and carried
		 * 6.76 `C*` against the panel's 5.56 — the panel's own colour, one step lighter, which
		 * is what the operator asked for. ΔE00 from `surface` 2.74, from
		 * `elevated` 1.30, from `sunken` 9.44. Ink on this ground: `ink` 7.19:1,
		 ...
		 * chroma (5.08 `C*` against 5.56), 36 degrees off its hue, ΔE00 4.17 from
