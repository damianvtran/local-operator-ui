...
export const ayuDark: ThemeDefinition = {
	...
	palette: {
		 ...
		 *
		 * rowHover    #2D3037  panel hue, C* 4.92,
		 *                       the rule's 0.60 x the panel's 7.90; +3.29 L*,
		 *                       ΔE00 3.23 off `surface`, `inkDim` 5.41:1.
		 * rowSelected #2B3445  panel hue, C* 11.84,
		 *                       the panel's cast + 4.0, floored at 5.0; +5.03 L*,
		 *                       ΔE00 4.41 off `surface` and 5.19 off
		 *                       `rowHover`; the pair ranks 1.74 `L*` and 6.9 `C*`,
		 *                       `inkDim` 5.12:1.
		 */
		rowHover: "#2D3037",
		rowSelected: "#2B3445",
