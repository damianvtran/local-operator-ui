...
export const cyberpunk: ThemeDefinition = {
	...
	palette: {
		 ...
		 *
		 * rowHover    #2C2932  panel hue, C* 6.43,
		 *                       the rule's 0.60 x the panel's 10.90; +2.37 L*,
		 *                       ΔE00 3.97 off `surface`, `inkDim` 5.23:1.
		 * rowSelected #302A3F  panel hue, C* 14.73,
		 *                       the panel's cast + 4.0, floored at 5.0; +3.69 L*,
		 *                       ΔE00 3.59 off `surface` and 6.26 off
		 *                       `rowHover`; the pair ranks 1.32 `L*` and 8.3 `C*`,
		 *                       `inkDim` 5.03:1.
		 */
		rowHover: "#2C2932",
		rowSelected: "#302A3F",
