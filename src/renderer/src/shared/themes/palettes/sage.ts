...
export const sage: ThemeDefinition = {
	...
	palette: {
		...
		// The user block's fill: ΔE00 4.20 off the canvas, where `surface` alone
		// measures 2.05 - a step toward `elevated` to clear the role's 4.0 floor,
		// which the block carries because the fill IS its boundary.
		messageSurface: "#fdfbf5",
