    ...
    <StyledCard>
      <StyledCardContent>
        ...
        <CardDescription variant="body2">
          This system prompt is given to all Local Operator agents. It is useful to define some baseline expectations for the behavior of every agent in your environment.  These instructions will be provided in addition to any specific instructions you may have defined for each agent.
        </CardDescription>
