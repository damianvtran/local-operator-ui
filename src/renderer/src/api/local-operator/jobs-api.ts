...
export const JobsApi = {
  ...
  async getJobStatus(
    ...
    if (!response.ok) {
      throw new Error(`Get job status request failed: ${response.status} ${response.statusText}`);
    }
  ...
  async cancelJob(
    ...
    if (!response.ok) {
      throw new Error(`Cancel job request failed: ${response.status} ${response.statusText}`);
    }
  ...
  async listJobs(
    ...
    if (!response.ok) {
      throw new Error(`List jobs request failed: ${response.status} ${response.statusText}`);
    }
  ...
  async cleanupJobs(
    ...
    if (!response.ok) {
      throw new Error(`Cleanup jobs request failed: ${response.status} ${response.statusText}`);
    }
